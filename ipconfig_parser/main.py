...
def encode_any_file(path: Path, target: str = "utf-8"):
    ...
    # encodings were pasted from: https://stackoverflow.com/questions/1728376/get-a-list-of-all-the-encodings-python-can-encode-to
    ...
    raise ValueError("Target Encode Type Was Not Found!")
